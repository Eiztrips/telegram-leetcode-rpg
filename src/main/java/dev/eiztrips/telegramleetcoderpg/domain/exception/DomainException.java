...
public sealed class DomainException extends RuntimeException permits ClientExceptions.ChatNotFoundException,
		...
		GuildExceptions.GuildAlreadyExists, GuildExceptions.GuildBossNotFountException,
		...
		TelegramException.InvalidCommandException, UserExceptions.UserAlreadyExistsException,
